...
void Menu::menuPrincipal(){
    ...
    do
    {
        ...
        showItem("            MENU CONSULTORIOS          ", 40, 18, y == 5);
        showItem("            MENU HISTORIA CLINICA      ", 40, 19, y == 6);
        rlutil::locate(40, 20);
        std::cout << "---------------------------------------" << std::endl;
        showItem("                 SALIR                 ", 40, 21, y == 7);
        ...
        case 1: //ENTER
            ...
            case 5:
                system("cls");
                _menuConsultorios.menuConsultorios();
                break;
            case 6:
                system("cls");
                _menuHistoriaClinica.menuHistoriaClinica();
                break;
